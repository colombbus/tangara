...
public class OutCmdNetMsgHandler extends AbstractNetMessageHandler {

	public static final String TYPE = "command-output";

	public OutCmdNetMsgHandler() {
		super(TYPE);
	}
	...
	public void processMessage(NetMessage netMsg, String connectID,
		...
		String outMsg = MessageFormat
				.format(
						Messages.getString("OutCmdNetMsgHandler.runScriptOuput"), netMsg.getSourceUser(), netMsg.getContent()); //$NON-NLS-1$
